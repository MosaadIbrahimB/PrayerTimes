...
class TimeHijriWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return    Row(
      ...
      children: [
        Text(hijriModel.year??"",style: AppStyle.textStyle18NotoKufia,),
        SizedBox(
          width: 10,
        ),
        Text(hijriModel.month??"",style: AppStyle.textStyle18NotoKufia,),
        SizedBox(
          width: 10,
        ),
        Text(hijriModel.numberDay??'',style: AppStyle.textStyle18NotoKufia,),
      ],
    ) ;
  }
}
