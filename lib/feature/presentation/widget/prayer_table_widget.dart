...
class _PrayerTableWidgetState extends State<PrayerTableWidget> {
  ...
  void initState() {
    prayerTime = [
      UIPrayerTimeModel(
          name: "صلاة الفجر", time: time12(widget.prayerTimes?.fajr)),
      UIPrayerTimeModel(
          name: "الشروق", time: time12(widget.prayerTimes?.sunrise)),
      UIPrayerTimeModel(
          name: "صلاة الظهر", time: time12(widget.prayerTimes?.dhuhr)),
      UIPrayerTimeModel(
          name: "صلاة العصر", time: time12(widget.prayerTimes?.asr)),
      UIPrayerTimeModel(
          name: "صلاة المغرب", time: time12(widget.prayerTimes?.maghrib)),
      UIPrayerTimeModel(
          name: "صلاة العشاء", time: time12(widget.prayerTimes?.isha)),
    ];
    super.initState();
  }
